...
INSERT INTO restaurants (name, description, email, phone, address, city, state, country, postal_code, cuisine, opening_time, closing_time, rating, is_active, logo_url, cover_image_url) VALUES
...
-- Insert dishes for Pasta Paradise (Italian)
...
-- Insert dishes for Sushi Sensation (Japanese)
INSERT INTO dishes (restaurant_id, name, description, price, category, is_available, image_url) VALUES
...
-- Insert dishes for Burger Bliss (American)
INSERT INTO dishes (restaurant_id, name, description, price, category, is_available, image_url) VALUES
...
-- Insert dishes for Taco Temple (Mexican)
INSERT INTO dishes (restaurant_id, name, description, price, category, is_available, image_url) VALUES
...
-- Insert dishes for Curry Corner (Indian)
INSERT INTO dishes (restaurant_id, name, description, price, category, is_available, image_url) VALUES
